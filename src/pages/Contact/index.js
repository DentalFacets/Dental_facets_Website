...
function Contact() {
  return (
    <>
      <Head>
        <title>Contact Us - Dental Facets</title>
        <meta
          name="description"
          content="Contact Dental Facets today for appointments and inquiries about our dental services and care."
        />
        <meta
          name="keywords"
        ...
        <div className={styles.StaticContainers}>
          ...
          <p>
            ...
            <span className={styles.linkTags}>
              <span className="text-gray-500">Monday - Saturday :</span> 10:00
              Am - 7:00 Pm ,<br />
