    ...
    <div className="relative top-16">
      ...
      >
        <div className={`md:w-2/3 lg:w-2/3`}>
          ...
          <p className={"text-pretty text-lg my-5 text-justify md:text-xl "}>
            ...
            essential to overall well-being. Our clinic is dedicated to provide
            comprehensive dental care with a focus on your comfort and
      ...
      <div className={`${styles.StaticContainers} md:flex md:items-center`}>
        <div className={" md:w-2/3 lg:w-2/3"}>
          ...
          <p className={"text-pretty text-lg my-5 text-justify md:text-xl "}>
            Founded with a deep passion for patient-centered care, Dental Facets
            has grown into a trusted name in the dental community. Our journey
            began with a clear mission: to provide exceptional dental care in a
            warm and welcoming environment. Over the years, we have remained
            true to this mission, consistently upgrading our skills and
            technology to meet the evolving needs of our patients.
          </p>
        </div>
        <div className={styles.imageWrapper}>
          <Image
